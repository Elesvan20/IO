...
Input:
    linea1: tipo de scoring: match, missmatch, gap
    linea2: Hilera1
    linea3: Hilera2
...
def main():
    print("Hello World Im the Generator")


'''
    Sintaxis
    python3 generator.py ID-PROBLEMA [parametros]
    
    donde
    ID-PROBLEMA es requerido obligatoriamente
'''